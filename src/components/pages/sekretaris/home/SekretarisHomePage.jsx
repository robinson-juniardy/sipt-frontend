...
import SekretarisPelayananPage from "../pelayanan/SekretarisPelayananPage";
      ...
      <Grid item xs={12}>
        <Box sx={{ width: "100%", typography: "body1" }}>
          <TabContext value={value}>
            ...
            <TabPanel value="1">Selamat Datang</TabPanel>
            <TabPanel value="2">
              <SekretarisPelayananPage />
            </TabPanel>
            <TabPanel value="3">
              <EkitaBulanan />
            </TabPanel>
...
export default SekretarisHomePage;
